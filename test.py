...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.left_side_panel.pack(
            side=tkinter.LEFT, fill=tkinter.Y, expand=False, padx=18, pady=10
        )
    ...
    def create_frame(self, frame_id, color):
        ...
        bt_from_frame1 = customtkinter.CTkButton(
            App.frames[frame_id],
            text="Test " + self.color_by_id(self.num_of_frames),
            command=lambda: print("test " + color),
        )
