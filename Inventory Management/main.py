...
sidebar_frame = CTkFrame(
    master=app, fg_color="#2A8C55", width=176, height=650, corner_radius=0
)
sidebar_frame.pack_propagate(0)
sidebar_frame.pack(fill="y", anchor="w", side="left")

logo_img_data = Image.open("./Inventory Management/logo.png")
logo_img = CTkImage(
...
analytics_img_data = Image.open("./Inventory Management/analytics_icon.png")
...
package_img_data = Image.open("./Inventory Management/package_icon.png")
...
list_img_data = Image.open("./Inventory Management/list_icon.png")
...
returns_img_data = Image.open("./Inventory Management/returns_icon.png")
...
settings_img_data = Image.open("./Inventory Management/settings_icon.png")
...
person_img_data = Image.open("./Inventory Management/person_icon.png")
...
main_view = CTkFrame(
    master=app, fg_color="#fff", width=680, height=650, corner_radius=0
)
...
CTkLabel(
    master=title_frame, text="Orders", font=("Arial Black", 25), text_color="#2A8C55"
...
logitics_img_data = Image.open("./Inventory Management/logistics_icon.png")
logistics_img = CTkImage(
    light_image=logitics_img_data, dark_image=logitics_img_data, size=(43, 43)
)
...
CTkLabel(
    master=orders_metric, text="Orders", text_color="#fff", font=("Arial Black", 15)
).grid(row=0, column=1, sticky="sw")
CTkLabel(
    master=orders_metric,
    text="123",
    text_color="#fff",
    font=("Arial Black", 15),
    justify="left",
...
shipping_img_data = Image.open("./Inventory Management/shipping_icon.png")
shipping_img = CTkImage(
    light_image=shipping_img_data, dark_image=shipping_img_data, size=(43, 43)
)
...
CTkLabel(
    master=shipped_metric, text="Shipping", text_color="#fff", font=("Arial Black", 15)
).grid(row=0, column=1, sticky="sw")
CTkLabel(
    master=shipped_metric,
    text="91",
    text_color="#fff",
    font=("Arial Black", 15),
    justify="left",
...
delivered_metric.pack(
    side="right",
)

delivered_img_data = Image.open("./Inventory Management/delivered_icon.png")
delivered_img = CTkImage(
    light_image=delivered_img_data, dark_image=delivered_img_data, size=(43, 43)
)
